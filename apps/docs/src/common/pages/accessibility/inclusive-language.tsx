      ...
      <h3>Age</h3>
        ...
        <p>As well as following our <a href="https://ukhomeoffice.github.io/accessibility-posters/">accessible design principles</a>, you should consider how your language is inclusive to people who face different barriers to accessing services.</p>
          ...
          <h3>Sex, gender and sexuality</h3>
            ...
            The UK currently doesn’t use an X marker for sex on identity documents, meaning that identity documents cannot have a sex other than male or female. <a href="https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/919615/euss-interim-guidance-gender-identity-and-sex-markers-on-documents-v1.0-ext.pdf">Current policy</a> states that for BRP cards or identity documents, caseworkers will need to contact them to ask for a preference for their identity documentation. If relevant to your service, you should inform users of this when providing an ‘other’ option for questions about their sex.
            </div>
            <h4>Gender</h4>
              <p>Do:</p>
              <ul>
