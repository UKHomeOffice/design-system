...
<div className="govuk-grid-row">
  <div className="govuk-grid-column-three-quarters">
    <img src={layoutImage01} alt="Diagram of a page layout with indication of regions: Header, Nav, Main, Footer and Aside" className="image-examples" />
  </div>
</div>
<br />
...
<div className="govuk-grid-row">
  <div className="govuk-grid-column-three-quarters">
    <img src={layoutImage02} alt="An example of a progress indicator - the steps are listed and the current step is highlighted" className="image-examples" />
  </div>
</div>
<p>The screenreader user can interact with this list to jump to any section directly.</p>
<br />
