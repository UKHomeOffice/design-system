...
const Page: FC<PageProps> = ({ location }) => (
  <div className="govuk-grid-row">
    ...
    <ul className="plain">
      ...
      <li><A href="#rr2.5.7">2.5.7 - Dragging movements</A></li>
    ...
    <p><A href="https://www.w3.org/WAI/WCAG22/Understanding/keyboard">Understanding Success Criterion 2.1.1: Keyboard</A></p>
    ...
    <ul>
      ...
      <li>Only interactive elements should receive keyboard focus. Do not add keyboard focus to headings or other non-interactive content</li>
    ...
    <p><A href="https://www.w3.org/WAI/WCAG22/Understanding/no-keyboard-trap">Understanding Success Criterion 2.1.2: No Keyboard Trap</A></p>
    <h4>Implementation guidance</h4>
    ...
    <p><A href="https://www.w3.org/WAI/WCAG22/Understanding/character-key-shortcuts">Understanding Success Criterion 2.1.4: Character Key Shortcuts</A></p>
    <h4>Implementation guidance</h4>
    ...
    <p>If single character key shortcuts exist, you should test that the shortcut keys:</p>
    <ul>
      <li>perform the function expected</li>
    ...
    <ul>
      <li>remapping options work including remapping to more complex or chorded shortcuts</li>
    </ul>
    <p>OR</p>
    <ul>
      <li>shortcut keys can be switched off.</li>
    </ul>
    <h4>Helpful links</h4>
    ...
    <p><A href="https://www.w3.org/WAI/WCAG22/Understanding/timing-adjustable">Understanding Success Criterion 2.2.1: Timing Adjustable</A></p>
    <h4>Implementation guidance</h4>
    ...
    <ul>
      ...
      <li>provide functionality to allow time limits to be extended when a warning is triggered or that allows users to set a timeout limit, for example in settings</li>
    </ul>
    ...
    <ul>
      <li>when a timeout occurs, check that a warning message is displayed before the timeout occurs and that an option to extend the session is offered</li>
    ...
    <ul>
      <li>that the timeout warning message is communicated to the screen reader</li>
      <li>that on timeout, a screen reader user is alerted that the timeout has occurred</li>
    </ul>
    <h4>Helpful links</h4>
    ...
    <p><A href="https://www.w3.org/WAI/WCAG22/Understanding/pause-stop-hide">Understanding Success Criterion 2.2.2: Pause, Stop, Hide</A></p>
    <h4>Implementation guidance</h4>
    ...
    <p><A href="https://www.w3.org/WAI/WCAG22/Understanding/three-flashes-or-below-threshold">Understanding Success Criterion 2.3.1: Three Flashes or Below Threshold</A></p>
    <h4>Implementation guidance</h4>
    <p>Content must not flash more than three times a second.</p>
    <h4>How to test with a visual check</h4>
    <p>Ensure any flashing or blinking content does not flash more than three times a second.</p>
    <h4>Helpful links</h4>
    ...
    <p>Verify that activating the link moves the visual and keyboard focus to the start of the main content.</p>
    <h4>Helpful links</h4>
    ...
    <p><A href="https://www.w3.org/WAI/WCAG22/Understanding/page-titled">Understanding Success Criterion 2.4.2: Page Titled</A></p>
    <h4>Implementation guidance</h4>
    ...
    <p><A href="https://www.w3.org/WAI/WCAG22/Understanding/focus-order">Understanding Success Criterion 2.4.3: Focus Order</A></p>
    <h4>Implementation guidance</h4>
    ...
    <h3 id="rr2.4.4">2.4.4 - Link purpose in context</h3>
    ...
    <p><A href="https://www.w3.org/WAI/WCAG22/Understanding/link-purpose-in-context">Understanding Success Criterion 2.4.4: Link Purpose (In Context)</A></p>
    <h4>Implementation guidance</h4>
    ...
    <h4>How to test with a visual check</h4>
    <p>Read all links on the page and check that they clearly and accurately describe their destination content, for example what page are they going to load.</p>
    <p>Activate the links and, if they open a new browser tab/window or content other than a web page (for example a PDF document), check that this is clear from their link text.</p>
    <h4>How to test with JAWS and NVDA</h4>
    <p>Use the JAWS/NVDA key + F7 to show the elements list which should show you all the links available on the page. Review this to check that the links make sense out of context.</p>
    ...
    <p><A href="https://www.w3.org/WAI/WCAG22/Understanding/headings-and-labels">Understanding Success Criterion 2.4.6: Headings and Labels</A></p>
    <h4>Implementation guidance</h4>
    ...
    <p><A href="https://www.w3.org/WAI/WCAG22/Understanding/focus-visible">Understanding Success Criterion 2.4.7: Focus Visible</A></p>
    <h4>Implementation guidance</h4>
    ...
    <p>The focus indication must meet 1.4.11 - Non text contrast requirements.</p>
    <h4>How to test with a keyboard</h4>
    ...
    <p>Check that browser default visible focus has been overridden and aligns to the style of the rest of the site.</p>
    <h4>Helpful links</h4>
    <p><A href="/accessibility/keyboard/focus">Home Office Design System - Keyboard focus</A></p>

    <h3 id="rr2.4.11">2.4.11 - Focus not obscured</h3>
    <p>When an element receives keyboard focus, the focus indicator is easy to see (not entirely hidden behind other elements).</p>
    <p><A href="https://www.w3.org/WAI/WCAG22/Understanding/focus-not-obscured-minimum">Understanding Success Criterion 2.4.11: Focus Not Obscured (Minimum)</A></p>
    <h4>Implementation guidance</h4>
    ...
    <p><A href="https://www.w3.org/WAI/WCAG22/Understanding/pointer-gestures">Understanding Success Criterion 2.5.1: Pointer Gestures</A></p>
    <h4>Implementation guidance</h4>
    ...
    <p>Ensure that gestures available on a mobile device have an accessible alternative which is communicated to screen reader users.</p>
    <h4>Helpful links</h4>
    ...
    <p><A href="https://www.w3.org/WAI/WCAG22/Understanding/pointer-cancellation">Understanding Success Criterion 2.5.2: Pointer Cancellation</A></p>
    <h4>Implementation guidance</h4>
    ...
    <p>There are some limited exceptions to this requirement where a down-key event is part of the expected behaviour. However, we don’t anticipate acceptable uses in the Home Office. If you have a requirement for down-key events, please discuss with the Accessibility Assurance team.</p>
    <h4>How to test with a visual check</h4>
    ...
    <p><A href="https://www.w3.org/WAI/WCAG22/Understanding/label-in-name">Understanding Success Criterion 2.5.3: Label in Name</A></p>
    <h4>Implementation guidance</h4>
    ...
    <p><A href="https://www.w3.org/WAI/WCAG22/Understanding/motion-actuation">Understanding Success Criterion 2.5.4: Motion Actuation</A></p>
    <h4>Implementation guidance</h4>
    ...
    <h4>How to test with a visual check</h4>
    <p>Identify controls or content which requires dragging, for example  drag-and-drop, drag to move position or slider control.</p>
    <p>Check if alternatives exist, for example drag-and-drop can be done by assigning an ordering, changing position can be done by arrow buttons and sliders can be moved using +/- buttons or value inputs.</p>
    <h4>How to test with a mobile device</h4>
    <p>Ensure that gestures available on a mobile device have an accessible alternative which is communicated to screen reader users.</p>
